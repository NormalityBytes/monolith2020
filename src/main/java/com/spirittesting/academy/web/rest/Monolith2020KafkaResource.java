...
@RestController
@RequestMapping("/api/monolith-2020-kafka")
public class Monolith2020KafkaResource {
    private final Logger log = LoggerFactory.getLogger(Monolith2020KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Monolith2020KafkaResource(KafkaProperties kafkaProperties) {
